...
namespace OneClickDesktop.Overseer
{
    public class Startup
    {
        ...
        private void createTestUsers(TestDataContext context)
        {
            ...
            {
                new User() { Id = Guid.NewGuid(), Username = "vagrant", PasswordHash = "vagrant", Role = TokenDTO.RoleEnum.User },
                new User() { Id = Guid.NewGuid(), Username = "user1", PasswordHash = "user1_pass", Role = TokenDTO.RoleEnum.User },
                new User() { Id = Guid.NewGuid(), Username = "user2", PasswordHash = "user2_pass", Role = TokenDTO.RoleEnum.User },
                new User() { Id = Guid.NewGuid(), Username = "admin1", PasswordHash = "admin1_pass", Role = TokenDTO.RoleEnum.Admin }
            };
